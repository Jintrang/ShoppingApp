...
CREATE TABLE tokens (
    ...
    user_id INT, --FK match to id of users
    FOREIGN KEY (user_id) REFERENCES users(id)
);

--hỗ trợ đăn nhập bằng fb và gg
...
CREATE TABLE product_images (
    ...
    CONSTRAINT fp_product_images_product_id ON DELETE CASCADE
...
CREATE TABLE order_details (
    ...
    number_of_products INTER CHECK(number_of_products > 0),
    total_money FLOAT CHECK(total_money >= 0),
